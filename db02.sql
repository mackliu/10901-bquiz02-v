...
(3, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 2),
...
INSERT INTO `visited` (`id`, `date`, `total`) VALUES
(1, '2020-07-18', 2),
(2, '2020-07-19', 2);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `visited`
--
ALTER TABLE `visited`
